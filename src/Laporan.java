...
public class Laporan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tanggal", "Pembeli", "Pesanan", "Harga", "Bayar", "Kembali"
            }
        ) {
        ...
        jScrollPane1.setBounds(30, 90, 340, 125);
        ...
        jPanel2.add(jLabel2);
        jLabel2.setBounds(130, 20, 120, 50);

        getContentPane().add(jPanel2);
        jPanel2.setBounds(0, -10, 400, 80);
    ...
    public void refresh() throws ParseException {
        ...
        String kolom[] = {"Tanggal","Pembeli","Pesanan","Harga","Bayar","Kembali"};
        ...
        try{
            while(rs.next()) {
                ...
                String Pesanan = rs.getString(4);
                String Harga = rs.getString(6);
                String Bayar = rs.getString(5);
                String Kembali = rs.getString(7);
                String data[] = {Tanggal,Pembeli,Pesanan,Harga,Bayar,Kembali};
                dtm.addRow(data);
            }
